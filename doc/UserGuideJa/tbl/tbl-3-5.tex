...
\index{ソルバ!potentialFoam@\OFtool{potentialFoam}}%
 ...
 ポテンシャル流のソルバです．
 速度ポテンシャルを解いて得られた流束場を再構成することで速度場を得ます． \\
...
\index{driftFluxFoam@\OFtool{driftFluxFoam}!ソルバ}%
\index{ソルバ!driftFluxFoam@\OFtool{driftFluxFoam}}%
 \OFtool{driftFluxFoam} &
 相同士の相対運動に対するドリフトフラックス近似による混合アプローチを用いた
 非圧縮性2相流用ソルバ \\
...
\index{reactingEulerFoam@\OFtool{reactingEulerFoam}!ソルバ}%
\index{ソルバ!reactingEulerFoam@\OFtool{reactingEulerFoam}}%
 \OFtool{reactingEulerFoam} &
 （解説なし） \\
...
\index{ソルバ!buoyantSimpleFoam@\OFtool{buoyantSimpleFoam}}%
 ...
 換気・熱輸送のための，浮力および輻射を伴う圧縮性乱流用定常状態ソルバ \\
