...
\index{ユーティリティ!equilibriumFlameT@\OFtool{equilibriumFlameT}}%
 ...
 平衡状態の炎の温度を計算する \\
\index{IFCLookUpTableGen@\OFtool{IFCLookUpTableGen}!ユーティリティ}%
\index{ユーティリティ!IFCLookUpTableGen@\OFtool{IFCLookUpTableGen}}%
 \OFtool{IFCLookUpTableGen} &
 与えられた燃料についてフィートの関数で無限の速さの化学関係を計算する。出力はモルで与えられる。 \\
