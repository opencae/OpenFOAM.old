...
\end{align}
 ...
 \item[hPolynomialThermo]
            ...
            次のケースがその使用例である：
            \OFpath{\$FOAM\_TUTORIALS/lagrangian/porousExplicitSourceReactingParcelFoam/filter}
\end{description}
...
このファイルの中では，\OFkeyword{simulationType}キーワードで
...
たとえば，\OFkeyword{nutWallFunction}，\OFkeyword{nutRoughWallFunction}，
\OFkeyword{nutSpalartAllmarasStandardRoughWallFunction}，
...
それぞれの壁関数境界条件では，\OFkeyword{E}と\OFkeyword{kappa}という
