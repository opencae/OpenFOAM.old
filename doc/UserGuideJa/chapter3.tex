...
\end{OFverbatim}%$
\OFpath{\$FOAM\_SOLVERS/incompressible/pisoFoam}ディレクトリで\verb|wmake|とタイプすれば
...
\OFpath{\$HOME/.OpenFOAM/2.0.0/controlDict}ファイルのように) コピーを
...
\index{キーワード!strategy@\OFkeyword{strategy}}%
            ...
            \scalebox{0.89}[1]{\OFpath{\$FOAM\_SRC/decompositionMethods/%
