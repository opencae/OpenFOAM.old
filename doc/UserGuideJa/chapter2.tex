...
しかし，バージョン1.6からは，
実行時に\OFpath{turbulenceProperties}ディクショナリで
...
// ************************************************************************* //
\end{OFverbatim}
\OFkeyword{simulationType}の選択肢は\OFkeyword{laminar}，
\OFkeyword{RASModel}，そして\OFkeyword{LESModel}です．
...
\OFkeyword{D}のソルバが\OFkeyword{GAMG}になっていることがわかります．
...
重力加速度は全領域にわたって一様で，
\OFpath{constant}ディレクトリの\OFpath{g}ファイルで指定されます．
...
キャビティの例題のように，\OFdictionary{turbulenceProperties}ディクショナリの
